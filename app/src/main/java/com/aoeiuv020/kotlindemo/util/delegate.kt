...
import com.aoeiuv020.kotlindemo.App
...
interface Pref {
    ...
    val sharedPreferencesName: String
        get() = ctx.packageName + "_$name"
    val sharedPreferences: SharedPreferences
        get() = ctx.getSharedPreferences(sharedPreferencesName, Context.MODE_PRIVATE)
}
...
sealed class PrefDelegate<T>(
    ...
    final override fun getValue(thisRef: Pref, property: KProperty<*>): T {
        ...
        return getValue(thisRef.sharedPreferences, realKey)
    }
